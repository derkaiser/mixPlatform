...
final class PreviousMixConnectionHandler extends Thread {
	...
	public void run() {
		...
		while (true) { // receive messages from previous mix
			...
			try {
				...
				previousMixInputStream.read(blockWithHeader);
				...
				if (	messageIdentifier 
					...
					//TODO: Batchsizemessage generieren und dann in Batchklasse prŸfen, ob es eine Batchsizemessage ist und entsprechend der (alten)
					//Methode behandeln.
	...
	private ChannelEstablishMessage readChannelEstablishMessage(
		...
		previousMixInputStream.read(restOfMessage);
